...
public abstract class TypedInterfaceDescriptor {
    ...
    @JsonSetter(nulls = Nulls.AS_EMPTY)
    @JsonProperty("fulltext-properties")
    private final Set<String> fulltextProperties;
    ...
    public TypedInterfaceDescriptor() {
        ...
        this.fulltextProperties = new HashSet<>();
    ...
    public <T extends TypedInterfaceDescriptor> T copyTo(Class<T> clazz) {
        try {
            ...
            descriptor.getFulltextProperties().addAll(this.fulltextProperties);
