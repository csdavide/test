package it.doqui.libra.librabl.cache;

public class CacheNode<T> implements LinkedListNode<T> {
    private final T value;
    private final DoublyLinkedList<T> list;
    private LinkedListNode<T> next;
    private LinkedListNode<T> prev;

    public CacheNode(T value, LinkedListNode<T> next, DoublyLinkedList<T> list) {
        this.value = value;
        this.next = next;
