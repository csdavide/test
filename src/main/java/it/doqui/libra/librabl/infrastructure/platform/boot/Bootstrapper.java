...
import it.doqui.libra.librabl.infrastructure.adapters.output.multitenant.TenantDataManager;
...
public class Bootstrapper {
    ...
    void init() throws UnknownHostException {
        ...
        instanceId = hostName + "_" + UuidCreator.getTimeOrderedEpoch();
        ...
        if (!schemaManager.getTenantNames().contains(TenantRef.DEFAULT_TENANT)) {
            ...
            var tenantService = Arc.container().select(TenantUseCase.class).get();
