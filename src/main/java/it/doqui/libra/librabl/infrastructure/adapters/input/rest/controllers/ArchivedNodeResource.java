...
public class ArchivedNodeResource extends AbstractResource {
    ...
    public Response getNode(
        ...
        @Parameter(
            ...
            schema = @Schema(type = SchemaType.ARRAY, implementation = String.class, enumeration = {"DEFAULT", "SYS_PROPERTIES", "PARENT_ASSOCIATIONS", "PARENT_HARD_ASSOCIATIONS", "SG", "TX", "NO_NULL_PROPERTIES", "EXTERNAL_PROPERTIES"})
        )
    ...
    public Response purgeNode(
        ...
        return call(() -> {
            archiveService.purgeNode(new Vertex(VertexType.UUID, uuid), wipeable);
