...
public class ServiceDispatcher implements InvocationHandler {
    ...
    public Object invoke(String methodName, Object[] args) throws Throwable {
        if (!cxfEnabled) {
            throw new EcmEngineException("CXF is disabled");
        }
        ...
        if (p != null) {
            ...
            try {
                ...
                sessionContextHolder.setUserContext(null);
                sessionContextHolder.setMode(SessionMode.SYNC);
            }
        } else {
