...
import it.doqui.libra.librabl.infrastructure.adapters.input.rest.dto.NamedItem;
import it.doqui.libra.librabl.infrastructure.adapters.input.rest.dto.PageOfSecurityGroups;
...
import it.doqui.libra.librabl.application.model.acl.PermissionsList;
...
public class SecurityGroupResource extends AbstractResource {
    ...
    @Inject
    SecurityGroupUseCase sgService;
