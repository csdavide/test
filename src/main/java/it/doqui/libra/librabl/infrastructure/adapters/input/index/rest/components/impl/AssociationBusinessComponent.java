...
import it.doqui.libra.librabl.infrastructure.adapters.input.index.cxf.components.AssociationServiceBridge;
import it.doqui.libra.librabl.infrastructure.adapters.input.index.cxf.components.AsyncOpServiceBridge;
import it.doqui.libra.librabl.infrastructure.adapters.input.index.cxf.components.NodeServiceBridge;
import it.doqui.libra.librabl.infrastructure.adapters.input.index.rest.components.interfaces.NodesBusinessInterface;
import it.doqui.libra.librabl.infrastructure.adapters.input.index.rest.dto.*;
...
public class AssociationBusinessComponent implements BusinessComponent {
    ...
    private Association convert(it.doqui.libra.librabl.infrastructure.adapters.input.index.rest.dto.Association association) {
