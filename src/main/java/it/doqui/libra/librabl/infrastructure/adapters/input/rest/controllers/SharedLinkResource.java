...
import it.doqui.libra.librabl.infrastructure.adapters.input.rest.dto.share.KeyRequestPayload;
...
public class SharedLinkResource extends AbstractResource {
    ...
    public Response downloadBySharedLink(
        ...
        @HeaderParam("X-Forwarded-Host") @TraceParam(ignore = true) String xForwardFor,
