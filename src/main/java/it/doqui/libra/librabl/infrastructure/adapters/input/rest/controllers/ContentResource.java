...
public class ContentResource extends AbstractContentResource {
    ...
    public Response updateDefaultNodeContent(
        ...
        return call(() -> {
            contentUseCase.setNodeContent(uuid, makeContentStream(CM_CONTENT, Optional.ofNullable(StringUtils.stripToNull(customContentType)).orElse(contentType), contentDisposition, body), currentFilename);
    ...
    public Response addDefaultNodeContent(
        ...
        return call(() -> {
            contentUseCase.addNodeContent(uuid, makeContentStream(CM_CONTENT, Optional.ofNullable(StringUtils.stripToNull(customContentType)).orElse(contentType), contentDisposition, body));
            return Response.noContent().build();
        });
    }
    ...
    public Response removeDefaultNodeContent(
        ...
        return call(() -> {
            contentUseCase.removeNodeContent(uuid, CM_CONTENT, fileName);
            return Response.noContent().build();
        });
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(operationId = "sealDefaultNodeContent", summary = "Seals a node content")
    @Traceable(traceAllParameters = true, category = TraceCategory.CREATE)
    @APIResponses(value = {
    ...
    public Response sealDefaultNodeContent(
        ...
        @QueryParam("fileName") String fileName,
        @RequestBody(
            description = "Params requested for sealing",
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(operationId = "signDefaultNodeContent", summary = "Signs a node content")
    @Traceable(traceAllParameters = true, category = TraceCategory.CREATE)
    @APIResponses(value = {
    ...
    public Response signDefaultNodeContent(
        @PathParam("uuid") String uuid,
        @QueryParam("fileName") String fileName,
        @RequestBody(
        ...
        return signDocument(uuid, CM_CONTENT, fileName, signRequest);
    }
    ...
    @Traceable(traceAllParameters = true, category = TraceCategory.READ)
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "A verify-certificate report is returned", content = @Content(schema = @Schema(implementation = DocumentOperationResponse.class))),
        @APIResponse(responseCode = "403", description = "Forbidden"),
        @APIResponse(responseCode = "404", description = "The specified node is not found"),
        @APIResponse(responseCode = "412", description = "The specified node content is not found"),
        @APIResponse(responseCode = "500", description = "Unexpected error")
