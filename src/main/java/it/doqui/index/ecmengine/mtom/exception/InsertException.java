...
/**
 * Eccezione lanciata in caso di errore durante la creazione di un nodo.
 * 
 * @author DoQui
 */
public class InsertException extends MtomException {
    private static final long serialVersionUID = 8536579146760324288L;
