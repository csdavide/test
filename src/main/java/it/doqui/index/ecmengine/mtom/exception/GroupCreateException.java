...
/**
 * Eccezione lanciata in caso di errore nella creazione di un gruppo.
 * 
 * @author DoQui
 */
public class GroupCreateException extends MtomException {
    private static final long serialVersionUID = 1596886721918537888L;
