...
/**
 * DTO che rappresenta la definizione di un tipo del modello dei dati.
 * 
 * @author DoQui
 */
public class TypeMetadata extends ModelComponentDTO {
    private static final long serialVersionUID = 1374505572419057255L;
    ...
    /**
     * Restituisce le definizioni delle associazioni sorgente-destinazione del tipo.
     *
    ...
    /**
     * Restituisce i metadati delle associazioni padre-figlio definite in questo
     * tipo.
     *
