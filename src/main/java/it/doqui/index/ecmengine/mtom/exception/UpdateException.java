...
/**
 * Eccezione lanciata in caso di errore durante l'aggiornamento di un nodo.
 * 
 * @author DoQui
 */
public class UpdateException extends MtomException {
    private static final long serialVersionUID = -2970618966847951882L;
