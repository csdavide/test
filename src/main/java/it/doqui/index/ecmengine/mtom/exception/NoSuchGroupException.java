...
/**
 * Eccezione lanciata quando non vengono trovati i gruppi necessari per
 * proseguire con l'elaborazione della richiesta.
 * 
 * @author DoQui
 */
public class NoSuchGroupException extends MtomException {
    private static final long serialVersionUID = 6556045343545476909L;
