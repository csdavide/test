...
/**
 * Eccezione lanciata in caso di errori transazionali.
 * 
 * @author DoQui.
 */
public class EcmEngineTransactionException extends MtomException {
    private static final long serialVersionUID = -7406223028690602059L;
