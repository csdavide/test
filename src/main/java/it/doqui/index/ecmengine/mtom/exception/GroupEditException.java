...
/**
 * Eccezione lanciata in caso di errore nella modifica di un gruppo.
 * 
 * @author DoQui
 */
public class GroupEditException extends MtomException {
    private static final long serialVersionUID = 9044982274341946964L;
