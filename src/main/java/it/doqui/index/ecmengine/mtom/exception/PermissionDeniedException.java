...
/**
 * Eccezione che viene lanciata quando l'utente non ha i permessi necessari per
 * l'esecuzione della richiesta.
 * 
 * @author DoQui
 */
public class PermissionDeniedException extends MtomException {
    private static final long serialVersionUID = 5825459415904509087L;
